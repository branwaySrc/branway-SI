          ...
          <Accordion allowMultiple className="border-[#FFFFFF30]">
            <AccordionItem>
              ...
              <AccordionPanel pt={8} pb={8}>
                ...
                기능제공을 하고 있습니다.
                <br />
                <br /> 만약 파트너님께서 요청하신 기능이 아임웹으로 구현이
                어렵다면, 아임웹에서 제공하는 기능을 통해 유사한 기능처럼
                사용하실 수 있도록 제안해 드려요. <br />
                <br />
                혹여나, 불가능 할 경우 사전에 미리 불가능 통보를 드리는 것을
                원칙으로 하고있습니다.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pt={8} pb={8}>
                ...
                사용을 위한 비용이 추가로 발생하게 됩니다.
                <br />
                <br /> 예를 들어, 토스페이먼츠와 같은 결제모듈은 초기 가입
                비용이 발생되며 그 외, 도메인 / 본인인증 문자 / 카카오채널 등
                유료서비스에 해당하는 기능은 별도로 부담해 주셔야 합니다.
              </AccordionPanel>
            </AccordionItem>
            ...
            <AccordionItem>
              ...
              <AccordionPanel pt={8} pb={8}>
                ...
                작업이 진행되게 됩니다. <br />
                <br /> 만약, 작업중 추가 내용이 있으시다면 기존 기획 틀에 있는
                한, 추가 내용을 반영해 드립니다. 해당 솔루션에 대해 세부내용을
                알고싶으시다면, 가격정책을 통해 확인해 주시거나 문의를 주시면
                더욱 상세히 안내받으실 수 있습니다.
