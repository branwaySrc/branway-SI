  ...
  return (
    <>
      ...
      <Section className="grid grid-cols-3 relative mt-5 w-full">
        ...
        <div className="bg-gradient-to-r via-transparent from-[#050505] w-[80%] h-full absolute top-0 left-0" />
        <div className="bg-gradient-to-l via-transparent from-[#050505]  w-[80%] h-full absolute top-0 right-0" />
        <div className="bg-gradient-to-b via-transparent from-[#050505]  w-full h-[30%] absolute top-0" />
        <div className="bg-gradient-to-t via-transparent from-[#050505]  w-full h-[30%] absolute bottom-0" />
