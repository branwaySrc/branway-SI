    ...
    <Section className="items-center justify-center hidden lg:flex">
      ...
      <Container className="z-10 w-full">
        ...
        <Section className="grid grid-cols-3 relative mt-5 w-full">
          <div className="bg-gradient-to-r via-transparent from-black w-[80%] h-full absolute top-0 left-0" />
          <div className="bg-gradient-to-l via-transparent from-black w-[80%] h-full absolute top-0 right-0" />
